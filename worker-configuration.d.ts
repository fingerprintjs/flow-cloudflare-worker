/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: ebda86df99a9e8425080f2551bd5bc3f)
...
declare namespace Cloudflare {
	...
	interface Env {
		FP_REGION: string;
		MISSING_SIGNALS_RESPONSE: string;
		FPJS_CDN_URL: string;
		FP_RULESET_ID: string;
		SECRET_KEY: string;
		FPJS_INGRESS_BASE_HOST: string;
		SCRIPTS_BEHAVIOR_PATH: string;
		PUBLIC_KEY: string;
