...
import { matchUrl, getAllowedOrigin } from '../../src/worker/urlMatching'
...
describe('URL matching', () => {
  ...
  describe('getAllowedOrigin', () => {
    it.each([
      [
        'should return the allowed origin if it matches exactly',
      ...
      [
        'should return null if the origin does not match',
        'https://api.example.com/endpoint',
        'https://app2.example.com',
        ['https://app1.example.com/signup'],
        false,
      ],
      [
        'should match one of multiple allowed origins',
        'https://api.example.com/endpoint',
        'https://app1.example.com',
        ['https://app2.example.com/page1', 'https://app1.example.com/page2'],
        true,
      ],
      [
        'should handle empty identification page URLs',
        'https://api.example.com/endpoint',
        'https://example.com',
        [],
        false,
      ...
      [
        'should not match origin with different protocol',
        'https://api.example.com/endpoint',
        'http://example.com',
        ['https://example.com'],
        false,
      ...
      [
        'should match when identification page includes wildcards',
        'https://api.example.com/endpoint',
        'https://example.com',
      ...
      [
        'should match when identification page includes subdomain wildcards',
        'https://api.example.com/endpoint',
      ...
      [
        'should match when identification page protocol omitted (http)',
        'https://api.example.com/endpoint',
        'http://example.com',
        ['example.com'],
        true,
      ...
      [
        'should match when identification page protocol omitted (https)',
        'https://api.example.com/endpoint',
        'https://example.com',
        ['example.com'],
        true,
      ...
      [
        'should match when identification page protocol omitted (wildcard)',
        'https://api.example.com/endpoint',
        'https://example.com',
        ['*example.com'],
        true,
      ...
      [
        'should not match root domain against wildcard subdomain identification page URL',
        'https://api.example.com/endpoint',
        'https://example.com',
        ['*.example.com'],
        false,
      ...
      [
        'should not match root domain against wildcard subdomain identification page url with a protocol',
        'https://api.example.com/endpoint',
        'https://example.com',
        ['https://*.example.com/page/1/*'],
        false,
      ...
      [
        'should not match for an invalid origin',
        'https://api.example.com/endpoint',
        'https://example.com/page',
        ['https://example.com'],
        false,
      ],
    ] as const)('%s', (_name, requestUrl, inputOrigin, identificationPageUrls, match) => {
      const env: TypedEnv = {
        ...mockEnv,
        IDENTIFICATION_PAGE_URLS: Array.from(identificationPageUrls),
      }
      ...
      const result = getAllowedOrigin(request, env)
      expect(result).toBe(match ? inputOrigin : null)
    })
  })
})
